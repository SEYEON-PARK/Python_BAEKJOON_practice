...
j=input() # 문자열(재환이가 가장 길게 낼 수 있는 "aaah") 입력받기
d=input() # 문자열(의사가 듣기 원하는 "aah") 입력받기

if(len(j)>=len(d)): # 만약, 문자열 j의 길이가 문자열 d의 길이보다 길거나 같다면
    print("go") # "go" 출력하기
else: # 문자열 j의 길이가 문자열 d의 길이보다 길거나 같지 않다면(짧다면)
    print("no") # "no" 출력하기
